...
type ResultCacheItem struct {
	...
	Start    time.Time     `protobuf:"bytes,2,opt,name=Start,json=start,proto3,stdtime" json:"Start"`
	End      time.Time     `protobuf:"bytes,3,opt,name=End,json=end,proto3,stdtime" json:"End"`
	TraceId  string        `protobuf:"bytes,4,opt,name=trace_id,json=traceId,proto3" json:"-"`
	Response *LokiResponse `protobuf:"bytes,5,opt,name=response,proto3" json:"response,omitempty"`
}

func (m *ResultCacheItem) Reset()      { *m = ResultCacheItem{} }
func (*ResultCacheItem) ProtoMessage() {}
func (*ResultCacheItem) Descriptor() ([]byte, []int) {
	return fileDescriptor_51b9d53b40d11902, []int{4}
}
func (m *ResultCacheItem) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ResultCacheItem) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ResultCacheItem.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *ResultCacheItem) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ResultCacheItem.Merge(m, src)
}
func (m *ResultCacheItem) XXX_Size() int {
	return m.Size()
}
func (m *ResultCacheItem) XXX_DiscardUnknown() {
	xxx_messageInfo_ResultCacheItem.DiscardUnknown(m)
}

var xxx_messageInfo_ResultCacheItem proto.InternalMessageInfo

func (m *ResultCacheItem) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *ResultCacheItem) GetStart() time.Time {
	if m != nil {
		return m.Start
	}
	return time.Time{}
...
func (m *ResultCacheItem) GetEnd() time.Time {
	if m != nil {
		return m.End
	}
	return time.Time{}
...
func (m *ResultCacheItem) GetTraceId() string {
	if m != nil {
		return m.TraceId
	}
	return ""
...
func (m *ResultCacheItem) GetResponse() *LokiResponse {
	if m != nil {
		return m.Response
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*ResultCacheItem)(nil), "queryrange.ResultCacheItem")
}
...
var fileDescriptor_51b9d53b40d11902 = []byte{
	...
	,
}
...
func (this *ResultCacheItem) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ResultCacheItem)
	if !ok {
		that2, ok := that.(ResultCacheItem)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *ResultCacheItem) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 9)
	s = append(s, "&queryrange.ResultCacheItem{")
...
func (m *ResultCacheItem) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ResultCacheItem) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	n7, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.Start, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n7
	...
	n8, err := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.End, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n8
...
func (m *ResultCacheItem) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *ResultCacheItem) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ResultCacheItem{`,
		...
		`Response:` + strings.Replace(fmt.Sprintf("%v", this.Response), "LokiResponse", "LokiResponse", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ResultCacheItem) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ResultCacheItem: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ResultCacheItem: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
